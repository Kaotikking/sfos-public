...
def fixture(tmp_path,hostile=None,first=False):
    ...
    plan={"schema":"SereinPublicOutpostGenerationPlan/v1","repository":"Kaotikking/sfos-public","repo_url":"https://github.com/Kaotikking/sfos-public.git","ref":"refs/heads/main","commit":commit,"tree":tree,"archive_url":f"https://github.com/Kaotikking/sfos-public/archive/{commit}.tar.gz","archive_sha256":sha(bundle.read_bytes()),"release_digest":release["self_digest"],"authority_key_id":"outpost-cognition-v1","authority_sha256":sha(cognition_public),"current_boot_id":boot,"immutable_rows":immutable_rows,"rollback_selector":rollback}
